...
namespace _1C.v8241
{
    ...
    public class Map
    {
        ...
        internal static string GetWACodeFromDMSCode(CodeType dmsCodeType, string dmsCodeValue)
        {
            ...
            switch (dmsCodeType)
            {
                ...
                case CodeType.VehicleType:
                    ...
                    break;
                case CodeType.AppointmentStatus:
                    switch (dmsCodeValue)
                    {
                ...
                //    }
                //    break;
                case CodeType.LogType:
                    switch (dmsCodeValue)
                    {
                        case "1": rtnValue = SystemCode.LogType.Planned; break;
                        case "2": rtnValue = SystemCode.LogType.Estimated; break;
                        case "3": rtnValue = SystemCode.LogType.Actual; break;
                    }
                    break;
        ...
        internal static string SetDMSCodeFromWACode(CodeType dmsCodeType, string dmsCodeValue)
        {
            string rtnValue = string.Empty;
            ...
            switch (dmsCodeType)
            {
                ...
                case CodeType.LogType:
                    switch (dmsCodeValue)
                    {
                        case SystemCode.LogType.Planned: rtnValue = "1"; break;
                        case SystemCode.LogType.Estimated: rtnValue = "2"; break;
                        case SystemCode.LogType.Actual: rtnValue = "3"; break;
                    }
                    break;
                case CodeType.PauseReasonCode:
                    switch (dmsCodeValue)
