...
namespace _1C.v8241
{
    public class ProxyService : _1C.v8241.Base.BaseProxy
    {
        public WA.Standard.IF.Data.v2.Common.Employee.EmployeeGetResponse EmployeeGet(WA.Standard.IF.Data.v2.Common.Employee.EmployeeGetRequest request)
        {
            ...
            //{
            //    if (response.Errors != null)
            //        response.Errors.Add(GetErrorData(WA.Standard.IF.Data.v2.Common.Common.ResponseCode.Fail, WA.Standard.IF.Data.v2.Common.Common.ResponseMessage.Fail));
            //    else
            //        response.Errors = GetErrorDataList(WA.Standard.IF.Data.v2.Common.Common.ResponseCode.Fail, WA.Standard.IF.Data.v2.Common.Common.ResponseMessage.Fail);
            //}
                    ...
                    if (proxyresponse.CustomerVehicles != null && proxyresponse.CustomerVehicles.Length > 0)
                    {
                        ...
                        foreach (_1C.v8241.CustomerVehicle.CustomerVehicle1 proxycustomervehicle in proxyresponse.CustomerVehicles)
                        {
                            ...
                            if (proxycustomervehicle.Customer != null && proxycustomervehicle.Vehicle != null)
                            {
                                ...
                                //vehicle.LastSixVIN = proxycustomervehicle.Vehicle.LastSixVIN; // 없음?
        ...
        public WA.Standard.IF.Data.v2.Common.CustomerVehicle.CustomerVehicleChangeResponse CustomerVehiclChange(WA.Standard.IF.Data.v2.Common.CustomerVehicle.CustomerVehicleChangeRequest request)
        {
            ...
            //Create proxy web service from dms web service with credential
            _1C.v8241.CustomerVehicleChange.CustomerVehicleChange proxyws = new _1C.v8241.CustomerVehicleChange.CustomerVehicleChange();
            proxyws.Credentials = proxycredential;

            //Create proxy request with customervehiclechange and transaction
            _1C.v8241.CustomerVehicleChange.CustomerVehicleChangeRequest proxyrequest = new _1C.v8241.CustomerVehicleChange.CustomerVehicleChangeRequest();

            //Create proxy transaction
            _1C.v8241.CustomerVehicleChange.TransactionHeader proxytransactionheader = new _1C.v8241.CustomerVehicleChange.TransactionHeader();
            if (request.TransactionHeader != null)
            {
                #region//TransactionHeader Set
                proxytransactionheader.CountryID = request.TransactionHeader.CountryID;
            ...
            _1C.v8241.CustomerVehicleChange.CustomerVehicleChange1 proxycustomervehiclechange = new _1C.v8241.CustomerVehicleChange.CustomerVehicleChange1();
            if (request.CustomerVehicleChange != null)
            {
                #region//CustomerVehicleChange Customer
                if (request.CustomerVehicleChange.Customer != null)
                {
                    _1C.v8241.CustomerVehicleChange.Customer proxycustomer = new _1C.v8241.CustomerVehicleChange.Customer();
                ...
                {
                    _1C.v8241.CustomerVehicleChange.Vehicle proxyvehicle = new _1C.v8241.CustomerVehicleChange.Vehicle();
            ...
            //Run proxy web method with proxy request
            _1C.v8241.CustomerVehicleChange.CustomerVehicleChangeResponse proxyresponse = proxyws.CallCustomerVehicleChange(proxyrequest);//이름을 왜?
            ...
            if (proxyresponse != null)
            {
                ...
                {
                    //Error List Set
                    foreach (_1C.v8241.CustomerVehicleChange.Error proxyerror in proxyresponse.Errors)
                    {
                        if (response.Errors != null)
                            response.Errors.Add(GetErrorData(proxyerror.Code, proxyerror.Message));
                        else
        ...
        public WA.Standard.IF.Data.v2.Common.Appointment.AppointmentGetResponse AppointmentGet(WA.Standard.IF.Data.v2.Common.Appointment.AppointmentGetRequest request)
        {
            ...
            if (request.AppointmentGet != null)
            {
                ...
                proxyappointmentget.DMSAppointmentStatus = Map.SetDMSCodeFromWACode(CodeType.AppointmentStatus, request.AppointmentGet.DMSAppointmentStatus);
                ...
                else
                {
                    ...
                    if (proxyresponse.Appointments != null && proxyresponse.Appointments.Length > 0)
                    {
                        ...
                        foreach (_1C.v8241.Appointment.Appointment1 proxyappointment in proxyresponse.Appointments)
                        {
                            ...
                            appointment.DMSAppointmentStatus = Map.GetWACodeFromDMSCode(CodeType.AppointmentStatus, proxyappointment.DMSAppointmentStatus);
                            ...
                            if (proxyappointment.JobRefs != null && proxyappointment.JobRefs.Length > 0)
                            {
                                ...
                                foreach (_1C.v8241.Appointment.JobRef proxyjobref in proxyappointment.JobRefs)
                                {
                                    ...
                                    jobref.DMSJobStatus = Map.GetWACodeFromDMSCode(CodeType.JobStatus, proxyjobref.DMSJobStatus);
                            ...
                            if (proxyappointment.RORefs != null && proxyappointment.RORefs.Length > 0)
                            {
                                ...
                                foreach (_1C.v8241.Appointment.RORef proxyroref in proxyappointment.RORefs)
                                {
                                    ...
                                    roref.DMSROStatus = Map.GetWACodeFromDMSCode(CodeType.ROStatus, proxyroref.DMSROStatus);
                            ...
                            if (proxyappointment.Customers != null && proxyappointment.Customers.Length > 0)
                            {
                                ...
                                foreach (_1C.v8241.Appointment.Customer proxycustomer in proxyappointment.Customers)
                                {
                                    ...
                                    customer.CustomerInfoType = Map.GetWACodeFromDMSCode(CodeType.CustomerInfoType, customer.CustomerInfoType);
                                    ...
                                    customer.Gender = Map.GetWACodeFromDMSCode(CodeType.Gender, customer.Gender);
                            ...
                            if (proxyappointment.Vehicle != null)
                            {
                                if (proxyappointment.Vehicle != null)
                                {
                                    ...
                                    //vehicle.LastSixVIN = proxyappointment.Vehicle.LastSixVIN; //없음??
        ...
        public WA.Standard.IF.Data.v2.Common.Appointment.AppointmentChangeResponse AppointmentChange(WA.Standard.IF.Data.v2.Common.Appointment.AppointmentChangeRequest request)
        {
            ...
            if (request.AppointmentChange != null)
            {
                ...
                proxyappointmentchange.DMSAppointmentStatus = Map.SetDMSCodeFromWACode(CodeType.AppointmentStatus, request.AppointmentChange.DMSAppointmentStatus);
        ...
        public WA.Standard.IF.Data.v2.Common.RepairOrder.RepairOrderGetResponse RepairOrderGet(WA.Standard.IF.Data.v2.Common.RepairOrder.RepairOrderGetRequest request)
        {
            ...
            if (request.RepairOrderGet != null)
            {
                ...
                proxyrepairorderget.DMSROStatus = Map.SetDMSCodeFromWACode(CodeType.ROStatus, request.RepairOrderGet.DMSROStatus);
                        ...
                        foreach (_1C.v8241.RepairOrder.RepairOrderDocument proxyrepairorderdocument in proxyresponse.RepairOrderDocuments)
                        {
                            ...
                            if (proxyrepairorderdocument.RepairOrders != null && proxyrepairorderdocument.RepairOrders.Length > 0)
                            {
                                ...
                                foreach (_1C.v8241.RepairOrder.RepairOrder1 proxyrepairorder in proxyrepairorderdocument.RepairOrders)
                                {
                                    ...
                                    repairorder.DMSROStatus = Map.GetWACodeFromDMSCode(CodeType.ROStatus, proxyrepairorder.DMSROStatus);
                                    ...
                                    if (proxyrepairorder.AppointmentRef != null)
                                    {
                                        ...
                                        appointmentref.DMSAppointmentStatus = Map.GetWACodeFromDMSCode(CodeType.AppointmentStatus, proxyrepairorder.AppointmentRef.DMSAppointmentStatus);
                                    ...
                                    if (proxyrepairorder.Vehicle != null)
                                    {
                                        if (proxyrepairorder.Vehicle != null)
                                        {
                                            ...
                                            vehicle.VehicleType = Map.GetWACodeFromDMSCode(CodeType.ContactType, proxyrepairorder.Vehicle.VehicleType);
                                                ...
                                                foreach (_1C.v8241.RepairOrder.OPCode proxyopcode in proxyrequestitem.OPCodes)
                                                {
                                                    ...
                                                    if (proxyopcode.MISCs != null && proxyopcode.MISCs.Length > 0)
                                                    {
                                                        ...
                                                        foreach (_1C.v8241.RepairOrder.MISC proxymisc in proxyopcode.MISCs)
                                                        {
                                                            ...
                                                            {
                                                                WA.Standard.IF.Data.v2.Common.Common.PriceType pricetype = new WA.Standard.IF.Data.v2.Common.Common.PriceType();
                                                                //pricetype.DiscountPrice = proxymisc.PriceType.DiscountPrice; // PriceType 데이터가 아님 단순 Object로 선언 됨
                                                                //pricetype.DiscountRate = proxymisc.PriceType.DiscountRate;
                                                                //pricetype.TotalPrice = proxymisc.PriceType.TotalPrice;
                                                                //pricetype.TotalPriceIncludeTax = proxymisc.PriceType.TotalPriceIncludeTax;
                                                                //pricetype.UnitPrice = proxymisc.PriceType.UnitPrice;
        ...
        public WA.Standard.IF.Data.v2.Common.RepairOrder.RepairOrderChangeResponse RepairOrderChange(WA.Standard.IF.Data.v2.Common.RepairOrder.RepairOrderChangeRequest request)
        {
            ...
            if (request.RepairOrderChange != null)
            {
                ...
                proxyrepairorderchange.DMSROStatus = Map.SetDMSCodeFromWACode(CodeType.ROStatus, request.RepairOrderChange.DMSROStatus);
                ...
                if (request.RepairOrderChange.AppointmentRef != null)
                {
                    ...
                    proxyappointmentref.DMSAppointmentStatus = Map.SetDMSCodeFromWACode(CodeType.AppointmentStatus, request.RepairOrderChange.AppointmentRef.DMSAppointmentStatus);
        ...
        public WA.Standard.IF.Data.v2.Common.Job.JobGetResponse JobGet(WA.Standard.IF.Data.v2.Common.Job.JobGetRequest request)
        {
            ...
            if (request.JobGet != null)
            {
                ...
                proxyjobget.DMSJobNo = request.JobGet.DMSJobNo;
                proxyjobget.DMSJobStatus = Map.SetDMSCodeFromWACode(CodeType.JobStatus, request.JobGet.DMSJobStatus);
                ...
                else
                {
                    ...
                    if (proxyresponse.Jobs != null && proxyresponse.Jobs.Length > 0)
                    {
                        ...
                        foreach (_1C.v8241.Job.Job1 proxyjob in proxyresponse.Jobs)
                        {
                            ...
                            {
                                job.JobLogs = new List<WA.Standard.IF.Data.v2.Common.Job.JobLog>();
                                foreach (_1C.v8241.Job.JobLog proxyjoblog in proxyjob.JobLogs)
                                {
                                    #region//Job JobLogs Header
                                    WA.Standard.IF.Data.v2.Common.Job.JobLog joblog = new WA.Standard.IF.Data.v2.Common.Job.JobLog();
                                    joblog.DMSJobStatus = proxyjoblog.DMSJobStatus;
                                    joblog.EstimatedLaborHour = proxyjoblog.EstimatedLaborHour;
                                    joblog.LogType = Map.GetWACodeFromDMSCode(CodeType.LogType, proxyjoblog.LogType);
                                    ...
                                    {
                                        joblog.Technicians = new List<WA.Standard.IF.Data.v2.Common.Job.Technician>();
                                        foreach (_1C.v8241.Job.Technician proxytechnician in proxyjoblog.Technicians)
                                        {
                                    ...
                                    {
                                        joblog.ActualTimeLogs = new List<WA.Standard.IF.Data.v2.Common.Job.ActualTimeLog>();
                                        foreach (_1C.v8241.Job.ActualTimeLog proxyactualtimelog in proxyjoblog.ActualTimeLogs)
                                        {
                                            ...
                                            actualtimelog.Status = Map.GetWACodeFromDMSCode(CodeType.ActualLogStatus, proxyactualtimelog.Status);
                                    ...
                                    {
                                        joblog.JobComments = new List<WA.Standard.IF.Data.v2.Common.Job.JobComment>();
                                        foreach (_1C.v8241.Job.JobComment proxyjobcomment in proxyjoblog.JobComments)
                                        {
                                            ...
                                            jobcomment.SubStatus = Map.GetWACodeFromDMSCode(CodeType.ActualLogSubStatus, proxyjobcomment.SubStatus);
        ...
        public WA.Standard.IF.Data.v2.Common.Job.JobChangeResponse JobChange(WA.Standard.IF.Data.v2.Common.Job.JobChangeRequest request)
        {
            ...
            //Create proxy transaction
            _1C.v8241.Job.TransactionHeader2 proxytransactionheader = new _1C.v8241.Job.TransactionHeader2();
            if (request.TransactionHeader != null)
            {
                #region//TransactionHeader Set
                proxytransactionheader.CountryID = request.TransactionHeader.CountryID;
            ...
            if (request.JobChange != null)
            {
                ...
                {
                    int commentscnt = 0;
                    _1C.v8241.Job.Comment1[] proxycomments = new _1C.v8241.Job.Comment1[request.JobChange.Comments.Count];
                ...
                {
                    int descriptionscnt = 0;
                    _1C.v8241.Job.Description1[] proxydescriptions = new _1C.v8241.Job.Description1[request.JobChange.Descriptions.Count];
                ...
                {
                    int causescnt = 0;
                    _1C.v8241.Job.Cause1[] proxycauses = new _1C.v8241.Job.Cause1[request.JobChange.Causes.Count];
                ...
                {
                    int correctionscnt = 0;
                    _1C.v8241.Job.Correction1[] proxycorrections = new _1C.v8241.Job.Correction1[request.JobChange.Corrections.Count];
                ...
                {
                    int opcodescnt = 0;
                    _1C.v8241.Job.OPCode1[] proxyopcodes = new _1C.v8241.Job.OPCode1[request.JobChange.OPCodes.Count];
                    foreach (WA.Standard.IF.Data.v2.Common.Job.OPCode opcode in request.JobChange.OPCodes)
                    {
                        #region//JobChange OPCode Header
                        _1C.v8241.Job.OPCode1 proxyopcode = new _1C.v8241.Job.OPCode1();
                        proxyopcode.ActualHours = opcode.ActualHours;
                        proxyopcode.Code = opcode.Code;
                        proxyopcode.Description = opcode.Description;
                        proxyopcode.EstimatedHours = opcode.EstimatedHours;
                ...
                {
                    int joblogsscnt = 0;
                    _1C.v8241.Job.JobLog1[] proxyjoblogs = new _1C.v8241.Job.JobLog1[request.JobChange.JobLogs.Count];
                    foreach (WA.Standard.IF.Data.v2.Common.Job.JobLog joblog in request.JobChange.JobLogs)
                    {
                        #region//JobChange JobLogs Header
                        _1C.v8241.Job.JobLog1 proxyjoblog = new _1C.v8241.Job.JobLog1();
                        proxyjoblog.DMSJobStatus = joblog.DMSJobStatus;
                        proxyjoblog.EstimatedLaborHour = joblog.EstimatedLaborHour;
                        proxyjoblog.LogType = Map.SetDMSCodeFromWACode(CodeType.LogType, joblog.LogType);
                        ...
                        if (joblog.Technicians != null && joblog.Technicians.Count > 0)
                        {
                            ...
                            _1C.v8241.Job.Technician1[] proxytechnicians = new _1C.v8241.Job.Technician1[joblog.Technicians.Count];
                            foreach (WA.Standard.IF.Data.v2.Common.Job.Technician technician in joblog.Technicians)
                            {
                                _1C.v8241.Job.Technician1 proxytechnician = new _1C.v8241.Job.Technician1();
                        ...
                        if (joblog.ActualTimeLogs != null && joblog.ActualTimeLogs.Count > 0)
                        {
                            ...
                            _1C.v8241.Job.ActualTimeLog1[] proxyactualtimelogs = new _1C.v8241.Job.ActualTimeLog1[joblog.ActualTimeLogs.Count];
                            foreach (WA.Standard.IF.Data.v2.Common.Job.ActualTimeLog actualtimelog in joblog.ActualTimeLogs)
                            {
                                _1C.v8241.Job.ActualTimeLog1 proxyactualtimelog = new _1C.v8241.Job.ActualTimeLog1();
                                ...
                                proxyactualtimelog.Status = Map.SetDMSCodeFromWACode(CodeType.ActualLogStatus, actualtimelog.Status);
                        ...
                        if (joblog.JobComments != null && joblog.JobComments.Count > 0)
                        {
                            ...
                            _1C.v8241.Job.JobComment1[] proxyjobcomments = new _1C.v8241.Job.JobComment1[joblog.JobComments.Count];
                            foreach (WA.Standard.IF.Data.v2.Common.Job.JobComment jobcomment in joblog.JobComments)
                            {
                                _1C.v8241.Job.JobComment1 proxyjobcomment = new _1C.v8241.Job.JobComment1();
                                proxyjobcomment.ActualWorkHour = jobcomment.ActualWorkHour;
                                proxyjobcomment.SubStatus = Map.SetDMSCodeFromWACode(CodeType.ActualLogSubStatus, jobcomment.SubStatus);
            ...
            if (proxyresponse != null)
            {
                ...
                {
                    //Error List Set
                    foreach (_1C.v8241.Job.Error1 proxyerror in proxyresponse.Errors)
                    {
                        if (response.Errors != null)
                            response.Errors.Add(GetErrorData(proxyerror.Code, proxyerror.Message));
                        else
                ...
                else
                {
                    ...
                    if (proxyresponse.Price != null)
                    {
                        ...
                        if (proxyprice.OPCodes != null && proxyprice.OPCodes.Length > 0)
                        {
                            ...
                            foreach (_1C.v8241.Price.OPCode1 proxyopcode in proxyprice.OPCodes)
                            {
                                ...
                                {
                                    opcode.Parts = new List<WA.Standard.IF.Data.v2.Common.Part.Part>();
                                    foreach (_1C.v8241.Price.Part1 proxypart in proxyopcode.Parts)
                                    {
        ...
        //public WA.Standard.IF.Data.v2.Common.Message.MessageSendResponse MessageSend(WA.Standard.IF.Data.v2.Common.Message.MessageSendRequest request)
        //{
        //    WA.Standard.IF.Data.v2.Common.Message.MessageSendResponse response = new WA.Standard.IF.Data.v2.Common.Message.MessageSendResponse();
        ...
        //    //Create proxy web service from dms web service with credential
        //    _1C.v8241.Message.Message proxyws = new _1C.v8241.Message.Message();
        //    proxyws.Credentials = proxycredential;

        //    //Create proxy request with messagesend and transaction
        //    _1C.v8241.Message.MessageSendRequest proxyrequest = new _1C.v8241.Message.MessageSendRequest();

        //    //Create proxy transaction
        //    _1C.v8241.Message.TransactionHeader proxytransactionheader = new _1C.v8241.Message.TransactionHeader();
        //    if (request.TransactionHeader != null)
        //    {
        //        #region//TransactionHeader Set
        //        proxytransactionheader.CountryID = request.TransactionHeader.CountryID;
        ...
        //    _1C.v8241.Message.MessageSend proxymessagesend = new _1C.v8241.Message.MessageSend();
        ...
        //    //Run proxy web method with proxy request
        //    _1C.v8241.Message.MessageSendResponse proxyresponse = proxyws.MessageSend(proxyrequest);
        ...
        //        {
        //            //Error List Set
        //            foreach (_1C.v8241.Message.Error proxyerror in proxyresponse.Errors)
        //            {
        //                if (response.Errors != null)
        //                    response.Errors.Add(GetErrorData(proxyerror.Code, proxyerror.Message));
        //                else
