    ...
    public class ProxyService : Base.BaseProxy
    {
                        ...
                        foreach (WA.v2.WS_RepairOrder.RepairOrderDocument proxyrepairorderdocument in proxyresponse.RepairOrderDocuments)
                        {
                            ...
                            if (proxyrepairorderdocument.RepairOrders != null && proxyrepairorderdocument.RepairOrders.Length > 0)
                            {
                                ...
                                foreach (WA.v2.WS_RepairOrder.RepairOrder1 proxyrepairorder in proxyrepairorderdocument.RepairOrders)
                                {
                                    ...
                                    repairorder.ROChannel = Map.GetWACodeFromDMSCode(CodeType.AppointmentChannel, proxyrepairorder.ROChannel);
                    ...
                    if (proxyresponse.Jobs != null && proxyresponse.Jobs.Length > 0)
                    {
                        ...
                        foreach (WA.v2.WS_Job.Job1 proxyjob in proxyresponse.Jobs)
                        {
                            ...
                            if (proxyjob.JobLogs != null && proxyjob.JobLogs.Length > 0)
                            {
                                ...
                                foreach (WA.v2.WS_Job.JobLog proxyjoblog in proxyjob.JobLogs)
                                {
                                    ...
                                    if (proxyjoblog.Technicians != null && proxyjoblog.Technicians.Length > 0)
                                    {
                                        ...
                                        foreach (WA.v2.WS_Job.Technician proxytechnician in proxyjoblog.Technicians)
                                        {
                                    ...
                                    if (proxyjoblog.ActualTimeLogs != null && proxyjoblog.ActualTimeLogs.Length > 0)
                                    {
                                        ...
                                        foreach (WA.v2.WS_Job.ActualTimeLog proxyactualtimelog in proxyjoblog.ActualTimeLogs)
                                        {
                                    ...
                                    if (proxyjoblog.JobComments != null && proxyjoblog.JobComments.Length > 0)
                                    {
                                        ...
                                        foreach (WA.v2.WS_Job.JobComment proxyjobcomment in proxyjoblog.JobComments)
                                        {
        ...
        public WA.Standard.IF.Data.v2.Common.Job.JobChangeResponse JobChange(WA.Standard.IF.Data.v2.Common.Job.JobChangeRequest request)
        {
            ...
            if (request.JobChange != null)
            {
                ...
                {
                    int joblogsscnt = 0;
                    WA.v2.WS_Job.JobLog1[] proxyjoblogs = new WA.v2.WS_Job.JobLog1[request.JobChange.JobLogs.Count];
                    foreach (WA.Standard.IF.Data.v2.Common.Job.JobLog joblog in request.JobChange.JobLogs)
                    {
                        #region//JobChange JobLogs Header
                        WA.v2.WS_Job.JobLog1 proxyjoblog = new WA.v2.WS_Job.JobLog1();
                        ...
                        if (joblog.Technicians != null && joblog.Technicians.Count > 0)
                        {
                            ...
                            WA.v2.WS_Job.Technician1[] proxytechnicians = new WA.v2.WS_Job.Technician1[joblog.Technicians.Count];
                        ...
                        if (joblog.ActualTimeLogs != null && joblog.ActualTimeLogs.Count > 0)
                        {
                            ...
                            WA.v2.WS_Job.ActualTimeLog1[] proxyactualtimelogs = new WA.v2.WS_Job.ActualTimeLog1[joblog.ActualTimeLogs.Count];
                        ...
                        if (joblog.JobComments != null && joblog.JobComments.Count > 0)
                        {
                            ...
                            WA.v2.WS_Job.JobComment1[] proxyjobcomments = new WA.v2.WS_Job.JobComment1[joblog.JobComments.Count];
        ...
        public WA.Standard.IF.Data.v2.Common.Message.MessageSendResponse MessageSend(WA.Standard.IF.Data.v2.Common.Message.MessageSendRequest request)
        {
            ...
            //Create proxy web service from dms web service with credential
            WA.v2.WS_Message.Message proxyws = new WA.v2.WS_Message.Message();
            proxyws.Credentials = proxycredential;

            //Create proxy request with messagesend and transaction
            WA.v2.WS_Message.MessageSendRequest proxyrequest = new WA.v2.WS_Message.MessageSendRequest();

            //Create proxy transaction
            WA.v2.WS_Message.TransactionHeader proxytransactionheader = new WA.v2.WS_Message.TransactionHeader();
            if (request.TransactionHeader != null)
            {
                #region//TransactionHeader Set
                proxytransactionheader.CountryID = request.TransactionHeader.CountryID;
            ...
            WA.v2.WS_Message.MessageSend proxymessagesend = new WA.v2.WS_Message.MessageSend();
            ...
            //Run proxy web method with proxy request
            WA.v2.WS_Message.MessageSendResponse proxyresponse = proxyws.MessageSend(proxyrequest);
            ...
            if (proxyresponse != null)
            {
                ...
                {
                    //Error List Set
                    foreach (WA.v2.WS_Message.Error proxyerror in proxyresponse.Errors)
                    {
                        if (response.Errors != null)
                            response.Errors.Add(GetErrorData(proxyerror.Code, proxyerror.Message));
                        else
