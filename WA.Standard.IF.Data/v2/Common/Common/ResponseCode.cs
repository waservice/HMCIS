...
namespace WA.Standard.IF.Data.v2.Common.Common
{
    public class ResponseCode
    {
        ...
        //ETC
        public const string WA_NoMatchedProxy = "WA00";

        //Common
        public const string WA_Timeout = "WA01";
        public const string WA_RequestEmpty = "WA02";
        public const string WA_UnHandledError = "WA03";
        public const string WA_TransactionHeaderNull = "WA04";
        public const string WA_RequestNull = "WA05";
        ...
        //JobGet
        public const string JG_Invalid_DMSRONo = "JG01";
        public const string JG_Invalid_DMSAppintmentNo = "JG02";
        public const string JG_Invalid_DMSJobNo = "JG03";
        ...
        public const string JC_Invalid_DMSJobNo = "JC14";
        public const string JC_Invalid_Status = "JC15";
        public const string JC_Invalid_PauseReasonCode = "JC16";
