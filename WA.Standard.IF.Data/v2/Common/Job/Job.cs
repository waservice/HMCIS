...
namespace WA.Standard.IF.Data.v2.Common.Job
{
    ...
    public class Job
    {
        ...
        private Plan _plan; public Plan Plan { get { return this._plan; } set { this._plan = value; } }
        private Dispatch _dispatch; public Dispatch Dispatch { get { return this._dispatch; } set { this._dispatch = value; } }
        private Actual _actual; public Actual Actual { get { return this._actual; } set { this._actual = value; } }
    }
}
