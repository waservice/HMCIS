...
namespace WA.Standard.IF.Data.v2.Common.PackageCode
{
    ...
    public class PackageCode
    {
        ...
        private string _displaypackagedescription = string.Empty; public string DisplayPackageDescription { get { return this._displaypackagedescription; } set { this._displaypackagedescription = value; } }
        ...
        private string _enginecode = string.Empty; public string EngineCode { get { return this._enginecode; } set { this._enginecode = value; } }
