...
namespace WA.Standard.IF.Data.v2.HMCIS.Price
{
    ...
    public class Price
    {
        ...
        private string _additionalrepairordersummary; public string AdditionalRepairOrderSummary { get { return this._additionalrepairordersummary; } set { this._additionalrepairordersummary = value; } }
        private List<WA.Standard.IF.Data.v2.Common.OPCode.OPCode> _opcodes; public List<WA.Standard.IF.Data.v2.Common.OPCode.OPCode> OPCodes { get { return this._opcodes; } set { this._opcodes = value; } }
